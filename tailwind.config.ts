		...
		extend: {
			colors: {
				...
				task: {
					...
					'todo-foreground': 'hsl(var(--task-todo-foreground))',
					'in-progress': 'hsl(var(--task-in-progress))',
					'in-progress-foreground': 'hsl(var(--task-in-progress-foreground))',
					done: 'hsl(var(--task-done))',
					'done-foreground': 'hsl(var(--task-done-foreground))'
				},
				priority: {
